		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    ...
                    <p class="mb-4" align="justify"> <b> Any computer applications is said to be a web application if we can access it’s services from web (Internet Service). To offer online business services to customers, we go for web applications. </p>
