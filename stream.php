		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
					...
					<table class="table table-bordered">
						<thead class="table-light"> 
							<tr> <th scope="col"> <b> Modifier and Type </b> </th> <th scope="col"> <b> Method </b> </th> <th scope="col"> <b> Description </b> </th> </tr>
						</thead>
						<tbody>
							<tr> <td align="justify"> boolean </td> <td align="justify"> allMatch(Predicate&#60;? super T&#62; predicate) </td> <td align="justify"> Returns whether all elements of this stream match the provided predicate. </td> </tr>
							<tr> <td align="justify"> boolean </td> <td align="justify"> anyMatch(Predicate&#60;? super T&#62; predicate) </td> <td align="justify"> Returns whether any elements of this stream match the provided predicate. </td> </tr>
							<tr> <td align="left"> static &#60;T&#62; Stream.Builder&#60;T&#62; </td> <td align="justify"> builder() </td> <td align="justify"> Returns a builder for a Stream. </td> </tr>
							<tr> <td align="justify"> &#60; R, A &#62; R </td> <td align="justify"> collect(Collector&#60;? super T,A,R&#62; collector) </td> <td align="justify"> Performs a mutable reduction operation on the elements of this stream using a Collector. </td> </tr>
							<tr> <td align="justify"> &#60; R &#62; R </td> <td align="justify"> collect(Supplier&#60;R&#62; supplier, BiConsumer&#60;R,? super T&#62; accumulator, BiConsumer&#60;R,R&#62; combiner) </td> <td align="justify"> Performs a mutable reduction operation on the elements of this stream. </td> </tr>
							<tr> <td align="justify"> static &#60;T&#62; Stream&#60;T&#62; </td> <td align="justify"> concat(Stream&#60;? extends T&#62; a, Stream&#60;? extends T&#62; b) </td> <td align="justify"> Creates a lazily concatenated stream whose elements are all the elements of the first stream followed by all the elements of the second stream. </td> </tr>
							<tr> <td align="justify"> long </td> <td align="justify"> count() </td> <td align="justify"> Returns the count of elements in this stream. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> distinct() </td> <td align="justify"> Returns a stream consisting of the distinct elements (according to Object.equals(Object)) of this stream. </td> </tr>
							<tr> <td align="justify"> static&#60;T&#62; Stream&#60;T&#62; </td> <td align="justify"> empty() </td> <td align="justify"> Returns an empty sequential Stream. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> filter(Predicate&#60;? super T&#62; predicate) </td> <td align="justify"> Returns a stream consisting of the elements of this stream that match the given predicate. </td> </tr>
							<tr> <td align="justify"> Optional&#60;T&#62; </td> <td align="justify"> findAny() </td> <td align="justify"> Returns an Optional describing some element of the stream, or an empty Optional if the stream is empty. </td> </tr>
							<tr> <td align="justify"> Optional&#60;T&#62; </td> <td align="justify"> findFirst() </td> <td align="justify"> Returns an Optional describing the first element of this stream, or an empty Optional if the stream is empty. </td> </tr>
							<tr> <td align="justify"> &#60;R&#62; Stream &#60;R&#62; </td> <td align="justify"> flatMap(Function&#60;? super T,? extends Stream&#60;? extends R&#62;&#62; mapper) </td> <td align="justify"> Returns a stream consisting of the results of replacing each element of this stream with the contents of a mapped stream produced by applying the provided mapping function to each element. </td> </tr>
							<tr> <td align="justify"> DoubleStream </td> <td align="justify"> flatMapToDouble(Function&#60;? super T,? extends DoubleStream&#60;? extends R&#62;&#62; mapper) </td> <td align="justify"> Returns an DoubleStream consisting of the results of replacing each element of this stream with the contents of a mapped stream produced by applying the provided mapping function to each element. </td> </tr>
							<tr> <td align="justify"> IntStream </td> <td align="justify"> flatMapToInt(Function&#60;? super T,? extends IntStream&#60;? extends R&#62;&#62; mapper) </td> <td align="justify"> Returns an IntStream consisting of the results of replacing each element of this stream with the contents of a mapped stream produced by applying the provided mapping function to each element. </td> </tr>
							<tr> <td align="justify"> LongStream </td> <td align="justify"> flatMapToLong(Function&#60;? super T,? extends LongStream&#60;? extends R&#62;&#62; mapper) </td> <td align="justify"> Returns an LongStream consisting of the results of replacing each element of this stream with the contents of a mapped stream produced by applying the provided mapping function to each element. </td> </tr>
							<tr> <td align="justify"> void </td> <td align="justify"> forEach(Consumer&#60;? super T&#62; action) </td> <td align="justify"> Performs an action for each element of this stream. </td> </tr>
							<tr> <td align="justify"> void </td> <td align="justify"> forEachOrdered(Consumer&#60;? super T&#62; action) </td> <td align="justify"> Performs an action for each element of this stream. </td> </tr>
							<tr> <td align="justify"> static &#60;T&#62; Stream<T> </td> <td align="justify"> generate(Supplier&#60;T&#62; s) </td> <td align="justify"> Returns an infinite sequential unordered stream where each element is generated by the provided Supplier. </td> </tr>
							<tr> <td align="justify"> static &#60;T&#62; Stream&#60;T&#62; </td> <td align="justify"> iterate(T seed, UnaryOperator&#60;T&#62; f) </td> <td align="justify"> Returns an infinite sequential ordered Stream produced by iterative application of a function f to an initial element seed, producing a Stream consisting of seed, f(seed), f(f(seed)), etc. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> limit(long maxSize) </td> <td align="justify"> Returns a stream consisting of the elements of this stream, truncated to be no longer than maxSize in length. </td> </tr>
							<tr> <td align="justify"> &#60;R&#62; Stream &#60;R&#62; </td> <td align="justify"> map(Function&#60;? super T,? extends R&#62; mapper) </td> <td align="justify"> Returns a stream consisting of the results of applying the given function to the elements of this stream. </td> </tr>
							<tr> <td align="justify"> DoubleStream </td> <td align="justify"> mapToDouble(ToDoubleFunction&#60;? super T&#62; mapper) </td> <td align="justify"> Returns a DoubleStream consisting of the results of applying the given function to the elements of this stream. </td> </tr>
							<tr> <td align="justify"> IntStream </td> <td align="justify"> mapToInt(ToIntFunction&#60;? super T&#62; mapper) </td> <td align="justify"> Returns an IntStream consisting of the results of applying the given function to the elements of this stream. </td> </tr>
							<tr> <td align="justify"> LongStream </td> <td align="justify"> mapToLong(ToLongFunction&#60;? super T&#62; mapper) </td> <td align="justify"> Returns a LongStream consisting of the results of applying the given function to the elements of this stream. </td> </tr>
							<tr> <td align="justify"> Optional&#60;T&#62; </td> <td align="justify"> max(Comparator&#60;? super T&#62; comparator) </td> <td align="justify"> Returns the maximum element of this stream according to the provided Comparator. </td> </tr>
							<tr> <td align="justify"> Optional&#60;T&#62; </td> <td align="justify"> min(Comparator&#60;? super T&#62; comparator) </td> <td align="justify"> Returns the minimum element of this stream according to the provided Comparator. </td> </tr>
							<tr> <td align="justify"> boolean </td> <td align="justify"> noneMatch(Predicate&#60;? super T&#62; predicate) </td> <td align="justify"> Returns whether no elements of this stream match the provided predicate. </td> </tr>
							<tr> <td align="justify"> static &#60;T&#62; Stream&#60;T&#62; </td> <td align="justify"> of(T... values) </td> <td align="justify"> Returns a sequential ordered stream whose elements are the specified values. </td> </tr>
							<tr> <td align="justify"> static &#60;T&#62; Stream&#60;T&#62; </td> <td align="justify"> of(T t) </td> <td align="justify"> Returns a sequential Stream containing a single element. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> peek(Consumer&#60;? super T&#62; action) </td> <td align="justify"> Returns a stream consisting of the elements of this stream, additionally performing the provided action on each element as elements are consumed from the resulting stream. </td> </tr>
							<tr> <td align="justify"> Optional&#60;T&#62; </td> <td align="justify"> reduce(BinaryOperator&#60;T&#62; accumulator) </td> <td align="justify"> Performs a reduction on the elements of this stream, using an associative accumulation function, and returns an Optional describing the reduced value, if any. </td> </tr>
							<tr> <td align="justify"> T </td> <td align="justify"> reduce(T identity, BinaryOperator&#60;T&#62; accumulator) </td> <td align="justify"> Performs a reduction on the elements of this stream, using the provided identity value and an associative accumulation function, and returns the reduced value. </td> </tr>
							<tr> <td align="justify"> &#60;U&#62; U </td> <td align="justify"> reduce(U identity, BiFunction&#60;U,? super T,U&#62; accumulator, BinaryOperator&#60;U&#62; combiner) </td> <td align="justify"> Performs a reduction on the elements of this stream, using the provided identity, accumulation and combining functions. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> skip(long n) </td> <td align="justify"> Returns a stream consisting of the remaining elements of this stream after discarding the first n elements of the stream. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> sorted() </td> <td align="justify"> Returns a stream consisting of the elements of this stream, sorted according to natural order. </td> </tr>
							<tr> <td align="justify"> Stream&#60;T&#62; </td> <td align="justify"> sorted(Comparator&#60;? super T&#62; comparator) </td> <td align="justify"> Returns a stream consisting of the elements of this stream, sorted according to the provided Comparator. </td> </tr>
							<tr> <td align="justify"> Object[] </td> <td align="justify"> toArray() </td> <td align="justify"> Returns an array containing the elements of this stream. </td> </tr>
							<tr> <td align="justify"> &#60;A&#62; A[] </td> <td align="justify"> toArray(IntFunction<A[]> generator) </td> <td align="justify"> Returns an array containing the elements of this stream, using the provided generator function to allocate the returned array, as well as any additional arrays that might be required for a partitioned execution or for resizing. </td> </tr>
						</tbody> 
					</table>
                </div>
            </div>
                     ...
                     <table class="table table-borderless">
                        <tbody align="left">
                            <tr>   
								...
								<td width="70%">  </td>	  
								<td> <a href="solidples.php" class="btn btn-primary rounded-pill d-none d-lg-block"> 
							         SOLID Principles <i class="fa fa-arrow-right ms-3"></i></a> 
								 </td> 
							</tr>
                        </tbody>
                    </table>
