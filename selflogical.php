...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> Logical Self Test Skills </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Logical Self Test Skills </h1>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-left mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> 1. Given </h4>
                    <ol>
						<li>  class Voop { </li>
					...
					<p class="mb-4" align="justify"> <b> Which, inserted independently at line 6, will compile? (Choose all that apply.) </b> </p>
                </div>
            </div>
        </div>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> 2. Which method names follow the JavaBeans standard ? </h4>
                    <p class="mb-4" align="justify"> A. addSize </p>
					<p class="mb-4" align="justify"> B. getCust </p>
					<p class="mb-4" align="justify"> C. deleteRep </p>
					<p class="mb-4" align="justify"> D. isColorado </p>
					<p class="mb-4" align="justify"> E. putDimensions </p>
					<p class="mb-4" align="justify"> <b> Answers : </b> B and D use the valid prefixes get and is. </p>
                </div>
            </div>
        </div>
