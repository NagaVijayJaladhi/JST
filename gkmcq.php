...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> Multiple Choose Questions </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3">  General Knowledge MCQ </h1>
                </div>
            </div>
        </div>
		
		<?php
			$sql = "SELECT * FROM GKMCQ";
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> <?php echo $row['GKID']; ?>. <?php echo $row['QUESTION']; ?> ? </h4>
                    <p class="mb-4" align="justify"> A. <?php echo $row['FOPTION']; ?> </p>
					<p class="mb-4" align="justify"> B. <?php echo $row['SOPTION']; ?> </p>
					<p class="mb-4" align="justify"> C. <?php echo $row['TOPTION']; ?> </p>
					<p class="mb-4" align="justify"> D. <?php echo $row['NOPTION']; ?> </p>
