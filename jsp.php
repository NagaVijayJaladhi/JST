...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> JSP </li>
                    </ol>
                </nav>
            </div>
        </div>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> JSP Advantages  </h4>
                    <p class="mb-4" align="justify"> 1. Extension to Servlet </p>
					<p class="mb-4" align="justify"> 2. Easy to maintain </p>
					<p class="mb-4" align="justify"> 3. Fast Development: No need to recompile and redeploy </p>
					<p class="mb-4" align="justify"> 4. Less code than Servlet </p>
                </div>
            </div>
        </div>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> JSP Lifecycle  </h4>
                    <p class="mb-4" align="justify"> Step 1 : Translation of JSP Page </p>
					<p class="mb-4" align="justify"> Step 2 : Compilation of JSP Page </p>
					<p class="mb-4" align="justify"> Step 3 : Classloading (the classloader loads class file) </p>
					<p class="mb-4" align="justify"> Step 4 : Instantiation (Object of the Generated Servlet is created). </p>
					<p class="mb-4" align="justify"> Step 5 : Initialization ( the container invokes jspInit() method).</p>
					<p class="mb-4" align="justify"> Step 6 : Request processing ( the container invokes _jspService() method). </p>
					<p class="mb-4" align="justify"> Step 7 : Destroy ( the container invokes jspDestroy() method). </p>
                </div>
            </div>
        </div>
