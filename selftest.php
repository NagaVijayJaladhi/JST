            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> Java Self Test Skills </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Java Self Test Skills </h1>
                </div>
            </div>
        </div>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    ...
                    <p class="mb-4" align="justify"> A. <?php echo $row['FIRST']; ?> </p>
					<p class="mb-4" align="justify"> B. <?php echo $row['SECOND']; ?> </p>
					<p class="mb-4" align="justify"> C. <?php echo $row['THIRD']; ?> </p>
					<p class="mb-4" align="justify"> D. <?php echo $row['FOURTH']; ?> </p>
