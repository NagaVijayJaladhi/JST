...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"> Interview Questions </a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page"> Python Self Test Skills </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Python Self Test Skills </h1>
                </div>
            </div>
        </div>
		
		<?php
			$sql = "SELECT `STID`, `QUESTION`, `FIRST`, `SECOND`, `THIRD`, `FOURTH`, `ANSWER` FROM `selftest` WHERE LANGUAGE = 'PYTHON'";
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> <?php echo $row['STID']; ?>. <?php echo $row['QUESTION']; ?> </h4>
                    <p class="mb-4" align="justify"> <?php echo $row['FIRST']; ?> </p>
					<p class="mb-4" align="justify"> <?php echo $row['SECOND']; ?> </p>
					<p class="mb-4" align="justify"> <?php echo $row['THIRD']; ?> </p>
					<p class="mb-4" align="justify"> <?php echo $row['FOURTH']; ?> </p>
					<p class="mb-4" align="justify"> <b> Answers : </b> <?php echo $row['ANSWER']; ?> </p>
                </div>
            </div>
        </div>
