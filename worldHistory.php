            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> World History </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> World History Timeline </h1>
                </div>
            </div>
        </div>
                ...
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
					<table class="table table-bordered">
						<thead class="table-light"> 
							<tr> <th scope="col"> <b> S.No </b> </th> <th scope="col"> <b> Year/Time </b> </th> <th scope="col"> <b> Events </b> </th>
							</tr>
						</thead>
						<tbody>		
							<?php
						...
						<thead class="table-light"> 
							<tr> <th scope="col" colspan="3"> <b> Common Era / Current Era / Christian Era (CE) </b> </th> </tr>
						</thead>
						<tbody>		
							<?php
