            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Abbreviation</a></li>
					...
					<table class="table table-bordered">
						<thead class="table-light"> 
							<tr> <th scope="col"> <b> S.No </b> </th> 
								 <th scope="col"> <b> Short Form </b> </th> 
								 <th scope="col"> <b> Full Form </b> </th> 
							</tr>
						</thead>
						<tbody>
							<?php
								$sql = "SELECT ROW_NUMBER() OVER (ORDER BY SHORTFORM ASC) AS ABBID,SHORTFORM,FULLFORM FROM abbrivation order by SHORTFORM ASC";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) {
									while ($row = $result->fetch_assoc()) {
							?>
							<tr> 
								<td align="justify"> <?php echo $row['ABBID']; ?> </td> 
								<td align="justify"> <?php echo $row['SHORTFORM']; ?> </td> 
								<td align="justify"> <?php echo $row['FULLFORM']; ?> </td> 
							</tr>
							<?php       
									}
								}
