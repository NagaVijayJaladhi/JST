...
$sql = "SELECT courses.COURSE, topics.TOPIC FROM courses INNER JOIN topics ON courses.CID = topics.CPID AND courses.CTYPE = topics.CTYPE";
						...
						<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<div class="classes-item h-100">
								<div class="bg-light rounded p-4 pt-5 h-100 d-flex flex-column justify-content-center">
									<a class="d-block text-center h3 mt-3 mb-4" href="joinUs"><?php echo $topic; ?></a>
								</div>
							</div>
						</div>
					<?php } ?>
