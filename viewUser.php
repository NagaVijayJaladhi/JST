        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> View Registred Users </h1>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
					<table class="table table-bordered">
						...
						<tbody>
							<?php
								$sql = "SELECT ROW_NUMBER() OVER (ORDER BY FULLNAME ASC) AS SNO,USERID,FULLNAME,USERNAME,EMAIL,MOBILENO,ROLE FROM user";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) {
									while ($row = $result->fetch_assoc()) {
							?>
							<tr> 
								<td align="justify"> <?php echo $row['SNO']; ?> </td> 
								<td align="justify"> <?php echo $row['USERID']; ?> </td> 
								<td align="justify"> <?php echo $row['FULLNAME']; ?> </td> 
								<td align="justify"> <?php echo $row['USERNAME']; ?> </td> 
								<td align="justify"> <?php echo $row['EMAIL']; ?> </td>
								<td align="justify"> <?php echo $row['MOBILENO']; ?> </td>
								<td align="justify"> <?php echo $row['ROLE']; ?> </td>								
								<td>  
									<a href="update.php?id='.$row['USERID'].'" title="Update Record" data-toggle="tooltip"><span class="fas fa-pencil-alt"> </span> </a> &nbsp;&nbsp;&nbsp;
									<a href="delete.php?id='.$row['USERID'].'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"> </span> </a>
								</td>								
							</tr>
							<?php       
									}
            ...
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                     <table class="table table-borderless">
                        <tbody align="left">
                            <tr>   
								<td> <a href="adminHome.php" class="btn btn-primary rounded-pill d-none d-lg-block"> 
								      <i class="fa fa-arrow-left ms-3"> </i> Admin Home </a> </td> 
							<td width="70%">  </td>
								<td> <a href="addUser.php" class="btn btn-primary rounded-pill d-none d-lg-block"> 
							         Add User  <i class="fa fa-arrow-right ms-3"> </i> </a> 
								 </td> 
							</tr>
                        </tbody>
                    </table>
