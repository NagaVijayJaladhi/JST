...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> Java Versions </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Java Versions </h1>
                </div>
            </div>
        </div>
		
		<?php
			$getRows = "SELECT JAVA_VER, RELDATE FROM `javaversions`";
			$res = $conn->query($getRows);			
			for ($x = 1; $x <= $res->num_rows; $x++) {
				$sql = "SELECT JAVA_VER, RELDATE FROM `javaversions` WHERE JVID = $x";
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h4 class="mb-3" align="left"> <?php echo $row['JAVA_VER']; ?> </h4>
					<p class="mb-4" align="justify"> <b class="text-success"> Release Date : </b> <?php echo $row['RELDATE']; ?> </p>
					<p class="mb-4" align="justify"> <b class="text-success"> Features : </b> </p>
					<?php
						$description = "SELECT DESCRIPTION FROM `javaversions` JV JOIN `javafeatures` JF WHERE JV.JVID = JF.JVID AND JF.JVID = $x";
						$descRes = $conn->query($description);
						if ($descRes->num_rows > 0) {
							$a = 1;
							while ($row = $descRes->fetch_assoc()) {
								
					?>	
					<p class="mb-4" align="justify"> <b> <?php echo $a; ?> . </b> &nbsp; <?php echo $row['DESCRIPTION']; ?> </p>
					<?php   
							$a++;
							}
						}
                        ...
                        <tbody align="left">
                            <tr>   
								<td> <a href="declarations.php" class="btn btn-primary rounded-pill d-none d-lg-block"> 
								      <i class="fa fa-arrow-left ms-3"></i> Declarations </a> </td> 
								<td width="70%">  </td>	  
								<td> <a href="jit.php" class="btn btn-primary rounded-pill d-none d-lg-block"> 
							          JIT Compiler <i class="fa fa-arrow-right ms-3"></i></a> 
								 </td> 
							</tr>
                        </tbody>
                    </table>
