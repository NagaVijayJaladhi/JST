            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"> Indian Parliament Acts </a></li>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Acts of the Parliament of India </h1>
                </div>
            </div>
        </div>
		...
		<div class="container-xxl">
            <div class="container">
                <div class="text-left mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <p class="mb-3"> This is a chronological and complete list of acts passed before 1861, by the Imperial Legislative Council between 1861 and 1947, the Constituent Assembly of India between 1947 and 1949, the Provisional Parliament between 1949 and 1952, and the Parliament of India since 1952. Apart from Finance Act, there are 891 Acts which are still in force as on 12.08.2025, majority of which have been amended from time to time. This list of Central acts which are in force is taken from the website of Ministry of Law and Justice. </p>
                </div>
            </div>
        </div>
					...
					<table class="table table-bordered">
						<thead class="table-light"> 
							<tr> <th scope="col"> <b> S.No </b> </th> 
								 <th scope="col"> <b> Name of the Act </b> </th> 
								 <th scope="col"> <b> Year </b> </th>
								 <th scope="col"> <b> Act Number </b> </th>								 
							</tr>
						</thead>
						<tbody>
							<?php
							...
							?>
							<tr> 
								<td align="justify"> <?php echo $row['IPAID']; ?> </td> 
								<td align="justify"> <?php echo $row['ACTNAME']; ?> </td> 
								<td align="justify"> <?php echo $row['YEAR']; ?> </td> 
								<td align="justify"> <?php echo $row['ACTNO']; ?> </td> 
							</tr>
							<?php       
									}
								}
