            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"> Spring Framework </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1500px;">
                    <h1 class="mb-3"> Spring Framework </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="img/spm.jpg" width="50%" style="object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <h1 class="mb-4"> Spring Framework Modules </h1>
								<ol>
									<li class="mb-4" align="justify"> Test </li>
									<li class="mb-4" align="justify"> Core Container </li>
									<li class="mb-4" align="justify"> AOP </li>
									<li class="mb-4" align="justify"> Aspects </li>
									<li class="mb-4" align="justify"> Instrumentation </li>
									<li class="mb-4" align="justify"> Data Access and Integration </li>
									<li class="mb-4" align="justify"> Web and Remoting </li>
								</ol>
                            </div>
                        </div>
                    </div>
