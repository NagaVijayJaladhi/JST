    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Development</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Development</li>
                    </ol>
                </nav>
            </div>
        </div>
		<div class="container-xxl">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1400px;">
                    <h1 class="mb-3"> About JST Development </h1>
                    <p class="mb-4" align="justify">  </P>
					<p class="mb-4" align="justify"> JST majorly provides Web and Android Based Products, Services, and Solutions as per the need of customers. The most trusted and preferred Web and Android Service Provider in INDIA. Within a short span of time delivered Products, Services and Solutions various Domains like E-Commerence, Banking, Medical, Industrialists, Institutions, Associations, and a variety of business sectors in INDIA. We also completed projects for more than 10 clients based in the USA. </p>
					<p class="mb-4" align="justify"> JST s the leading digital platform for all business firms across the world and an one stop automated solution for your trade and industry. On the public interest we have done our platform in high quality and cost-effective software development and implementation of services. We have different products and services to meet your requirements. We provide the optimum and customized solutions made for your organization. </p>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="bg-light rounded">
                    <div class="row mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1400px;">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="img/WEBD.jpeg" style="object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
            ...
            <div class="container">
                <div class="row mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 1400px;">
                    ...
                    <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.5s" style="min-height: 400px;">
                        <div class="row">
                            <div class="position-relative h-100">
								<img class="img-fluid w-100 h-100 p-4 mb-5 py-6" src="img/FYAP.JPG" alt="" style="object-fit: cover;">
                            </div>
                        </div>
                    </div>
                </div>
